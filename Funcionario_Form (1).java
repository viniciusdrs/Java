...
public class Funcionario_Form extends JFrame {
	...
	public Funcionario_Form() {
		...
		lblNome.setBounds(103, 116, 46, 14);
		contentPane.add(lblNome);
		
		textNome = new JTextField();
		textNome.setBounds(175, 113, 189, 20);
		contentPane.add(textNome);
		textNome.setColumns(10);
		
		JLabel lblEmail = new JLabel("EMAIL");
		lblEmail.setBounds(103, 149, 46, 14);
		contentPane.add(lblEmail);
		
		textEmail = new JTextField();
		textEmail.setBounds(175, 146, 189, 20);
		contentPane.add(textEmail);
		textEmail.setColumns(10);
		
		JLabel lblTelefone = new JLabel("TELEFONE");
		lblTelefone.setBounds(103, 180, 70, 14);
		contentPane.add(lblTelefone);
		
		textTelefone = new JTextField();
		textTelefone.setBounds(175, 177, 189, 20);
		contentPane.add(textTelefone);
		textTelefone.setColumns(10);
		
		JLabel lblCpf = new JLabel("CPF");
		lblCpf.setBounds(103, 205, 46, 14);
		contentPane.add(lblCpf);
		
		textCpf = new JTextField();
		textCpf.setBounds(175, 205, 189, 20);
		contentPane.add(textCpf);
		textCpf.setColumns(10);
		
		JLabel lblIdade = new JLabel("IDADE");
		lblIdade.setBounds(103, 230, 46, 14);
		contentPane.add(lblIdade);
		
		textIdade = new JTextField();
		textIdade.setBounds(175, 230, 189, 20);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 Control.FuncionarioControler.insereFuncionarioControl(textNome.getText(),
				textEmail.getText(),
